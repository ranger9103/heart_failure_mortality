  ...
  d3.json("samples.json").then((data) => {
    ...
    var gaugeData = [{
      ...
      gauge: {
        ...
        axis: { range: [null, 10] },
        steps: [
            { range: [0, 2], color: 'rgb(219, 20, 20)' },
            { range: [2, 4], color: 'rgb(219, 170, 20)' },
            { range: [4, 6], color: 'rgb(219, 219, 20)' },
            { range: [6, 8], color: 'rgb(170, 219, 20)' },
            { range: [8, 10], color: 'rgb(20, 219, 70)' },
        ]},
    }];
